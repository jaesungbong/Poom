...
public class DetailStoryTabsAdapter extends FragmentPagerAdapter implements
	...
	public DetailStoryTabsAdapter(FragmentActivity activity, TabHost tabHost,
			ViewPager pager) {
		this(activity, activity.getSupportFragmentManager(), tabHost, pager);
	}

	public DetailStoryTabsAdapter(Context context, FragmentManager fragmentManager,
